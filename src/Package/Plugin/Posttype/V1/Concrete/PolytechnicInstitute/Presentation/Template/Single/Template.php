<?php
namespace Ababilithub\FlexPortfolio\Package\Plugin\Posttype\V1\Concrete\PolytechnicInstitute\Presentation\Template\Single;
...
class Template 
{
    ...
    public function enqueue_scripts()
    {
        ...
        wp_enqueue_style(
            PLUGIN_PRE_HYPH.'-'.PolytechnicInstitutePosttype::POSTTYPE.'-template-style', 
        ...
        wp_enqueue_script(
            PLUGIN_PRE_HYPH.'-'.PolytechnicInstitutePosttype::POSTTYPE.'-template-script', 
        ...
        wp_localize_script(
            PLUGIN_PRE_HYPH.'-'.PolytechnicInstitutePosttype::POSTTYPE.'-template-localize-script', 
            PLUGIN_PRE_UNDS.'_'.PolytechnicInstitutePosttype::POSTTYPE.'_template_localize', 
            array(
                'adminAjaxUrl' => admin_url('admin-ajax.php'),
                'ajaxUrl' => admin_url('admin-ajax.php'),
                'ajaxNonce' => wp_create_nonce(PLUGIN_PRE_UNDS.'_'.PolytechnicInstitutePosttype::POSTTYPE.'_nonce'),

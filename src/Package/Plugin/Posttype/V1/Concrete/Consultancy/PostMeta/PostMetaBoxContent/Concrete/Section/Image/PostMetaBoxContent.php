<?php
namespace Ababilithub\FlexPortfolio\Package\Plugin\Posttype\V1\Concrete\Consultancy\PostMeta\PostMetaBoxContent\Concrete\Section\Image;
...
class PostMetaBoxContent extends BasePostMetaBoxContent
{
    ...
    public function init(array $data = []) : static
    {
        ...
        $this->tab_item_icon = 'fas fa-images';

<?php
namespace Ababilithub\FlexPortfolio\Package\Plugin\Menu\V1\Concrete\Taxonomy\Portfolio\Type;
    ...
    class Menu extends BaseMenu
    {
        ...
        public function add_menu_items($menu_items = [])
        {
            $menu_items[] = [
                ...
                'menu_title' => 'Portfolio Type',
                'capability' => 'manage_options',
                'menu_slug' => 'edit-tags.php?taxonomy='.PortfolioTypeTaxonomy::TAXONOMY,
                'callback' => '',
                'position' => 3,
            ];

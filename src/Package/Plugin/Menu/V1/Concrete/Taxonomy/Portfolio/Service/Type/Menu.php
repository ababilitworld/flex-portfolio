<?php
namespace Ababilithub\FlexPortfolio\Package\Plugin\Menu\V1\Concrete\Taxonomy\Portfolio\Service\Type;
    ...
    class Menu extends BaseMenu
    {
        ...
        public function add_menu_items($menu_items = [])
        {
            $menu_items[] = [
                ...
                'menu_title' => 'Service Type',
                'capability' => 'manage_options',
                'menu_slug' => 'edit-tags.php?taxonomy='.PortfolioServiceTypeTaxonomy::TAXONOMY,
                'callback' => '',
                'position' => 2,
            ];

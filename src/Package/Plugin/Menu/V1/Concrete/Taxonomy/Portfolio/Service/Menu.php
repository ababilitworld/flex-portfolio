<?php
namespace Ababilithub\FlexPortfolio\Package\Plugin\Menu\V1\Concrete\Taxonomy\Portfolio\Service;
    ...
    class Menu extends BaseMenu
    {
        ...
        public function add_menu_items($menu_items = [])
        {
            $menu_items[] = [
                ...
                'menu_slug' => 'edit-tags.php?taxonomy='.PortfolioServiceTaxonomy::TAXONOMY,
                'callback' => '',
                'position' => 1,
            ];

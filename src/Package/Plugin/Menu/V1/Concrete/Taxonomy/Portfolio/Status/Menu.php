<?php
namespace Ababilithub\FlexPortfolio\Package\Plugin\Menu\V1\Concrete\Taxonomy\Portfolio\Status;
    ...
    class Menu extends BaseMenu
    {
        ...
        public function add_menu_items($menu_items = [])
        {
            $menu_items[] = [
                ...
                'menu_title' => 'Portfolio Status',
                'capability' => 'manage_options',
                'menu_slug' => 'edit-tags.php?taxonomy='.PortfolioStatusTaxonomy::TAXONOMY,
                'callback' => '',
                'position' => 4,
            ];

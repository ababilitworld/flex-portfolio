<?php
namespace Ababilithub\FlexPortfolio\Package\Plugin\Menu\V1\Concrete\Posttype\Typography;
...
use Ababilithub\{
    ...
    FlexPortfolio\Package\Plugin\Posttype\V1\Concrete\Typography\Posttype as TypographyPosttype
};

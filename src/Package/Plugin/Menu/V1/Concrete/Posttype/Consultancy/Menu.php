<?php
namespace Ababilithub\FlexPortfolio\Package\Plugin\Menu\V1\Concrete\Posttype\Consultancy;
    ...
    class Menu extends BaseMenu
    {
        ...
        public function add_menu_items($menu_items = [])
        {
            $menu_items[] = [
                ...
                'menu_title' => 'Consultancy',
                'capability' => 'manage_options',
                'menu_slug' => 'edit.php?post_type='.ConsultancyPosttype::POSTTYPE,
                'callback' => '',
                'position' => 3,
            ];

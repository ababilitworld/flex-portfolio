<?php
namespace Ababilithub\FlexPortfolio\Package\Plugin\Menu\V1\Concrete\Posttype\PolytechnicInstitute;
...
if (!class_exists(__NAMESPACE__.'\Menu')) 
{
    ...
    class Menu extends BaseMenu
    {
        ...
        public function add_menu_items($menu_items = [])
        {
            $menu_items[] = [
                'type' => 'submenu',
                'parent_slug' => 'flex-portfolio',
                'page_title' => 'PolytechnicInstitute',
                'menu_title' => 'PolytechnicInstitute',
                'capability' => 'manage_options',
                'menu_slug' => 'edit.php?post_type='.PolytechnicInstitutePosttype::POSTTYPE,
                'callback' => '',
                'position' => 3,
            ];

<?php
namespace Ababilithub\FlexPortfolio\Package\Plugin\Menu\V1\Concrete\Posttype\ImportantLink;
...
use Ababilithub\{
    ...
    FlexPortfolio\Package\Plugin\Posttype\V1\Concrete\ImportantLink\Posttype as ImportantLinkPosttype
};

<?php
namespace Ababilithub\FlexPortfolio\Package\Plugin\Menu\V1\Concrete\Shortcode\Portfolio\Service;
    ...
    class Menu extends BaseMenu
    {
        ...
        public function add_menu_items($menu_items = [])
        {
            $menu_items[] = [
                ...
                'menu_slug' => 'flex-portfolio-service-list',
        ...
        {
            echo do_shortcode("[ababilithub-portfolio-service]");
        }
